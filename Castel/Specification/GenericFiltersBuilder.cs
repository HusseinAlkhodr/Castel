...
namespace Castel.Specification
{
    public abstract class GenericFiltersBuilder<TEntity, TFilter>
        : IGenericFiltersBuilder<TEntity, TFilter> where TEntity : class where TFilter : class
    {
